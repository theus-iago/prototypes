  ...
  static exibir() {
    ...
    if (this.type == "alert") {
      ...
      if(localStorage.getItem("msg") != null) {
        ...
        text.innerHTML = localStorage.getItem("msg");
      ...
      const localBloco = [[...document.querySelectorAll("#bloco")], style_bloco];
      localStorage.setItem("bloco", JSON.stringify(localBloco));
        msg.value = "";
      });
    }
