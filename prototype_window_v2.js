class Janela {
  ...
  static exibir() {
    ...
    if (this.type == "alert") {
      ...
      footer.appendChild(botao_close);
      ...
      botao_send.setAttribute("style", style_botao_footer);
      ...
      botao_send.addEventListener("click", () => {
        ...
        main_bloco = document.querySelector("box_main");
        main_bloco.style.alignItems = "end";
        main_bloco.appendChild(bloco);
      });
    }
