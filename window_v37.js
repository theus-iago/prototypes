class Janela {
  ...
  static exibir() {
    ...
    const allItens = [...document.querySelectorAll(":not(#area_msg)")];
    const itensSelect = allItens.filter(element => element.style.display != "");
    itensSelect.forEach(element => {
  ...
  static ocultar() {
    const allItens = [...document.querySelectorAll(":not(#area_msg)")];
    const itensSelect = allItens.filter(element => element.style.display == "static");
    itensSelect.forEach(element => {
